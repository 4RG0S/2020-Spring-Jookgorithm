...
public class Main {
    ...
    public static long[][] matMul(long[][] mat1, long[][] mat2) {
        ...
        ret[0][0] = ((mat1[0][0] * mat2[0][0]) + (mat1[0][1] * mat2[1][0])) % 1000000007;
        ret[0][1] = ((mat1[0][0] * mat2[0][1]) + (mat1[0][1] * mat2[1][1])) % 1000000007;
        ret[1][0] = ((mat1[1][0] * mat2[0][0]) + (mat1[1][1] * mat2[1][0])) % 1000000007;
        ret[1][1] = ((mat1[1][0] * mat2[0][1]) + (mat1[1][1] * mat2[1][1])) % 1000000007;
